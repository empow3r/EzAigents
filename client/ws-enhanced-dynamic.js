// Enhanced WebSocket Client with Dynamic Port Detection
class ObservabilityDashboard {
    constructor() {
        // Dynamically determine WebSocket URL based on current page URL
        ...
        if (window.location.protocol === 'file:') {
            ...
            console.log('File protocol detected, using default:', this.wsUrl);
        } else {
    ...
    connect() {
        ...
        this.ws.onerror = (error) => {
            ...
            console.log('Make sure the server is running on', this.wsUrl);
        };
    ...
    exportCSV() {
        ...
        window.location.href = `${baseUrl}/export/csv`;
    }
